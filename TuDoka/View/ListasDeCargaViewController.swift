//
//  ListasDeCargaViewController.swift
//  TuDoka
//
...
class ListasDeCargaViewController: UIViewController,UITableViewDataSource, UITableViewDelegate,UINavigationControllerDelegate{
    ...
    @IBAction func btnContinuar(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "¿Estás seguro de querer continuar?", message: "No podrás agregar más listas de carga en este reporte", preferredStyle: .alert)
...
extension ListasDeCargaViewController: UIImagePickerControllerDelegate{
