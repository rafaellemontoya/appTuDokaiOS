...
class FotosCapacitacionVC:  UIViewController, UITableViewDataSource, UITableViewDelegate,UINavigationControllerDelegate {
    ...
    @IBAction func continuarBTN(_ sender: Any) {
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("Agregar", comment: "Default action"), style: .default, handler: { _ in
            ...
            self.performSegue(withIdentifier: "agregarItemCapacitacionSegue", sender: self)
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("Continuar", comment: "Default action"), style: .default, handler: { _ in
            NSLog("The \"OK\" alert occured.")
            //regreso a la pantalla anterior
            self.performSegue(withIdentifier: "resumenItemsCapacitacionSegue", sender: self)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.fotosItemCapacitacion = self
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "agregarItemCapacitacionSegue"){
            let receiver = segue.destination as! ItemsCapacitacionVC
            receiver.reporte = self.reporte!
        }else if(segue.identifier == "resumenItemsCapacitacionSegue"){
            let receiver = segue.destination as! ResumenCapacitacionVC
            receiver.reporte = self.reporte!
        }
    }
...
extension FotosCapacitacionVC: UIImagePickerControllerDelegate{
